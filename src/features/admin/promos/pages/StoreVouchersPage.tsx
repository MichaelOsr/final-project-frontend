...
export function StoreVouchersPage() {
  ...
  }, [isReady, storeId, page, q, discountType, voucherType, startDate, endDate, sortBy, sortOrder]);
  ...
  function openEdit(v: Voucher) { navigate(`/admin/store/vouchers/${v.id}/edit`); }
    ...
    <AdminDashboardShell>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage vouchers for this store.</p>
        </div>
        <Button asChild>
          <Link to="/admin/store/vouchers/new">
