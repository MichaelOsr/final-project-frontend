...
// Inventory > List tab: current stock per product with inline adjust / clear.
// `storeId` is resolved by the parent shell (store context).
export function StockListTab({ storeId }: { storeId: string }) {
  ...
  }, [storeId, page, query, categoryId, sortBy, sortOrder, refreshKey]);
